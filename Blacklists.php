...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['blacklistApplicant'])) {
        ...
        echo "<script>
                alert('The applicant has been blacklisted!');
    ...
    <div class="u-clearfix u-sheet u-sheet-1">
            <div class="search-form-container">
                ...
                try {
                    ...
                    $buttonStyle = "width: 120px; height: 45px; display: inline-block; line-height: 25px; text-align: center; border-radius: 20px;"; // increased border-radius
                    ...
                    if ($searchResult->num_rows > 0) {
                        ...
                        while ($row = $searchResult->fetch_assoc()) {
                            ...
                            <form method='POST' action='unblacklist.php' style='display:inline;'>
                                <input type='hidden' name='unblacklist_data' value='" . htmlspecialchars($row['IC'], ENT_QUOTES, 'UTF-8') . ", " . htmlspecialchars($row['email'], ENT_QUOTES, 'UTF-8') . ", " . htmlspecialchars($row['project'], ENT_QUOTES, 'UTF-8') ."'>
