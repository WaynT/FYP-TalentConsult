...
if (isset($_GET['projectname'])) {
    ...
    $query = "SELECT * FROM PIC WHERE projectname='$projectname'";
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        die("No project found with the name: " . htmlspecialchars($projectname));
    }
} else {
...
<html style="font-size: 16px;" lang="en"><head>
    ...
    <title>Projects_PIC</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="Projects_PIC.css" media="screen">
    ...
    <meta property="og:title" content="Projects_PIC">
  ...
  <body data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="en"><header class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-clearfix u-header" id="sec-1c6a" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction=""><div class="u-clearfix u-sheet u-sheet-1">
        <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
          ...
          <div class="u-custom-menu u-nav-container">
            <ul class="u-nav u-spacing-30 u-unstyled u-nav-1"><li class="u-nav-item"><a class="u-border-2 u-border-active-grey-90 u-border-hover-grey-50 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-grey-90 u-text-grey-90 u-text-hover-grey-90" href="Lists_PIC.php" style="padding: 10px 0px;">Lists</a><div class="u-nav-popup"><ul class="u-border-2 u-border-grey-75 u-h-spacing-7 u-nav u-unstyled u-v-spacing-12"><li class="u-nav-item"><a class="u-active-custom-color-1 u-button-style u-hover-custom-color-1 u-nav-link u-white" href="Blacklists.html">Blacklists</a>
    ...
    <section class="u-clearfix u-section-1" id="sec-a6be">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-border-3 u-border-grey-dark-1 u-container-style u-group u-radius u-shape-round u-group-1">
          <div class="u-container-layout u-container-layout-1">
            <h5 class="u-text u-text-default u-text-1">Project: <?php echo htmlspecialchars($row['projectname']); ?></h5>
            <h5 class="u-text u-text-default u-text-2">Recruiters: <?php echo htmlspecialchars($row['recruiters']); ?></h5>
            <a href="#" class="u-active-palette-2-light-1 u-border-none u-btn u-btn-round u-button-style u-custom-color-1 u-hover-palette-2-light-1 u-radius u-btn-1">Pass </a>
            <a href="#" class="u-active-palette-2-light-1 u-border-none u-btn u-btn-round u-button-style u-custom-color-1 u-hover-palette-2-light-1 u-radius u-btn-2">Attend </a>
            <a href="#" class="u-active-palette-2-light-1 u-border-none u-btn u-btn-round u-button-style u-custom-color-1 u-hover-palette-2-light-1 u-radius u-btn-3">Fail </a>
          </div>
        </div>
      </div>
    </section>
